...
$ip = $_SERVER['HTTP_CLIENT_IP'] ?? "Invalid";
echo json_encode(['processedString' => $ip, 'rawIspInfo' => ""]);
die();


/**
 * On August 4th, 2020, we removed this section in favor of
 * processing the ip string in a separate piece of server-side code.
 */
