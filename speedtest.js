...
function getDirpath() {
    // var scriptURL = document.currentScript != null ? document.currentScript.src : ""
...
Speedtest.prototype = {
    ...
    start: function () {
        ...
        var workerURL = "./speedtest_worker.js?r=" + Math.random();
        var dirURL = getDirpath();

        console.log(dirURL);
        var url = new URL(workerURL, dirURL);
        console.log(url);
