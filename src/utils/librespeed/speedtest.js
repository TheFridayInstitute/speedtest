...
Speedtest.prototype = {
  ...
  start: function() {
    ...
    var workerUrl = this._settings.workerURL || "speedtest_worker.js";
    ...
    this._state = 3;
    // Filter out client-only settings before sending to worker
    var workerSettings = Object.assign({}, this._settings);
    delete workerSettings.workerURL;
